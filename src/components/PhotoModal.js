...
export class PhotoModal extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { userDict: null };
    }

    async componentDidMount() {
        const userDict = await Users.getUserDict();
        this.setState({ userDict: userDict });
    }

    render() {
        return <>{ this.state.userDict && (
            ...
            <Modal isOpen={this.props.isOpen} toggle={this.props.toggle} size="xl">
                ...
                <ModalBody>
                    ...
                    <div style={{width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                        ...
                        <span>By: </span>
                        <UserTag 
                            user={this.state.userDict[this.props.photo.userId]} 
                            isActive={Users.getUser().id === this.props.photo.userId}
                        />
                        </div>
